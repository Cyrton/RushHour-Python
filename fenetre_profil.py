...
def chargement(pseudo,canvas_profil,fenetre_P,score,Fenetre_Principale,Fenetre_Jouer):
...
def Fenetre_profil(canvas_jouer,fenetre_P,Fenetre_Jouer,pseudo,Fenetre_Principale,fenetre_d,canvas_level):
    ...
    boutonGO = Button(canvas_profil, text="Jouer", command= lambda: ApplicationNv1(10, 300,  125,score,fenetre_P,canvas_profil,pseudo,Fenetre_profil,Fenetre_Principale,Fenetre_Jouer),fg ='black',bg = '#66EC62',activebackground='light green',font="Arial 11 bold",width =35, height = 1)
    ...
    chargement(pseudo,canvas_profil,fenetre_P,score,Fenetre_Principale,Fenetre_Jouer)
    fenetre_P.mainloop()
