...
def Fenetre_Principale(fenetre_P,canvas_jouer, canvas_classement):
    ...
    boutonC = Button(canvas_general, text="CHARGER", bd =10,state = NORMAL, command = lambda: Fenetre_Charger(fenetre_P,Fenetre_Principale,canvas_general), font="Arial 16 bold",bg= 'sky blue',activebackground='sky blue',relief="groove", width = 20, height =1)
